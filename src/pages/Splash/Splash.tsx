  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background-secondary to-background-tertiary flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center animate-fade-in">
        {/* App Logo */}
        <div className="mb-8">
          <div className="w-32 h-32 bg-surface border border-border rounded-xl flex items-center justify-center mb-6 shadow-sm mx-auto">
            <span className="text-5xl font-bold text-text-primary">A</span>
          </div>
        ...
        {/* Tagline */}
        <div className="mb-16">
          <p className="text-xl text-text-secondary font-medium animate-slide-up" style={{ animationDelay: '0.3s' }}>
            Tap. Send. Receive.
          </p>
          <p className="text-sm text-text-tertiary mt-2 animate-slide-up" style={{ animationDelay: '0.6s' }}>
        ...
        {isLoading && (
          <div className="flex flex-col items-center animate-scale-in">
            <div className="relative">
              <div className="w-16 h-16 border-4 border-surface-tertiary rounded-full"></div>
              <div className="absolute top-0 left-0 w-16 h-16 border-4 border-border border-t-transparent rounded-full animate-spin"></div>
              <div className="absolute top-0 left-0 w-16 h-16 border-4 border-border/60 border-t-transparent rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
            </div>
