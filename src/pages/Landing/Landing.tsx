...
import { ArrowRightIcon, ShieldCheckIcon, BoltIcon, CreditCardIcon, QrCodeIcon, LockClosedIcon, SparklesIcon, HandRaisedIcon } from '@heroicons/react/24/outline';
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="px-8 py-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-2xl font-light tracking-wider text-text-primary">AURAPAY</span>
          </div>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center gap-12">
            <a href="#features" className="text-text-secondary hover:text-text-primary transition-colors text-sm tracking-wide">FEATURES</a>
            <button 
      ...
      <section id="features" className="px-8 py-32 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-4xl font-light text-text-primary mb-6 tracking-wide">WHY AURAPAY?</h2>
          ...
          <div className="space-y-16">
            {features.map((feature, index) => (
              <div key={index} className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-12 md:gap-20`}>
                {/* Icon Section */}
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="inline-block px-6 py-2 bg-text-primary/10 border border-text-primary/20 rounded-full mb-6">
                    <span className="text-text-primary text-sm tracking-wide font-medium">0{index + 1}</span>
                  </div>
                  <h3 className="text-4xl font-light text-text-primary mb-6 tracking-wide">{feature.title}</h3>
                  <p className="text-text-secondary text-lg tracking-wide leading-relaxed max-w-md">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="px-8 py-32">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-light text-text-primary mb-8 tracking-wide">READY TO BEGIN?</h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-8 md:mb-0">
              <span className="text-xl font-light tracking-wider text-text-primary">AURAPAY</span>
            </div>
            <div className="text-center md:text-right">
              <p className="text-text-secondary text-sm tracking-wide">&copy; 2024 AuraPay. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
